...
public:
	...
	friend Number& operator/(Number &numOne, int num);
	friend Number& operator/(Number &numOne, long num);
	friend ostream& operator<< (ostream &out,Number &numOne);
	friend istream& operator>> (istream &in, Number &numOne);
	friend ofstream& operator<< (ofstream& os, Number &numOne);
	friend ifstream& operator>> (ifstream& is, Number &numOne);
	void writetobin(fstream& os);
	void readfrombin(fstream& os);
